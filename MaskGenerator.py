...
class MaskCreatorApp(ctk.CTk):
   def __init__(self):
       ...
       self.load_btn = ctk.CTkButton(self.button_frame, text="📂 Open Picture", command=self.load_image)
       self.load_btn.pack(side="left", padx=10)

       self.save_btn = ctk.CTkButton(self.button_frame, text="💾 Save ROIs", command=self.save_mask)
       self.save_btn.pack(side="left", padx=10)

       self.clear_btn = ctk.CTkButton(self.button_frame, text="🧹 Clean ROIs", command=self.clear_rectangles)
       ...
       self.quit_btn = ctk.CTkButton(self, text="Close", command=self.destroy)
